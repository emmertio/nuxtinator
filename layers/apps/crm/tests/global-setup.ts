// Vitest global setup for the `crm` project. Mirrors context's setup: boot
// Nuxt (the dev host) with the test DB env, wipe any crm-prefixed leftovers
// on entry/exit.
...
export async function setup() {
  ...
  await cleanupCrmTestData(admin)
